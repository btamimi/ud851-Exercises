...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder>{
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        int layoutIdForInflator = R.layout.number_list_item;
        boolean shouldAttachedToParentImidiatly = false;

        View view = inflater.inflate(layoutIdForInflator,parent,shouldAttachedToParentImidiatly);
