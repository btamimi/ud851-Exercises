...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadSizeFromSharedPreferece(sharedPreferences);
    ...
    private void loadSizeFromSharedPreferece(SharedPreferences sharedPreferences){
        float minSize = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_font_size_key),getString(R.string.pref_font_size_defval)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        else if(key.equals(R.string.pref_font_size_key)){
            float minSize = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_font_size_key), "1.0"));
            mVisualizerView.setMinSizeScale(minSize);
        }
    }
