...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        new GitbubQueryTask().execute(githubSearchUrl);
    ...
    public class GitbubQueryTask extends AsyncTask<URL ,Void,String>{
        ...
        protected String doInBackground(URL... urls) {
            ...
            try {
                queryResult = NetworkUtils.getResponseFromHttpUrl(githubSearchURL);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return queryResult;
