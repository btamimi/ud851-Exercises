...
public class MainActivity extends AppCompatActivity {
    ...
    private String LIFECYCLE_CALLBACKS_TEXT_KEY = "Contain";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
            String previousText = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            mLifecycleDisplay.setText(previousText);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String oldText = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY,oldText);
    }
